...
void GPIO_X_MeasurementSetup(void)
{
    ...
    P_PinState = ((XP_GPIO_Port->ODR & XP_Pin) != 0 ? 1 : 0);
    M_PinState = ((XM_GPIO_Port->ODR & XM_Pin) != 0 ? 1 : 0);
...
void GPIO_Y_MeasurementSetup(void)
{
    ...
    P_PinState = ((YP_GPIO_Port->ODR & YP_Pin) != 0 ? 1 : 0);
    M_PinState = ((YM_GPIO_Port->ODR & YM_Pin) != 0 ? 1 : 0);
