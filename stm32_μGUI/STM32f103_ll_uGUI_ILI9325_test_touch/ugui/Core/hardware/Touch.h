...
#define XP_Pin LL_GPIO_PIN_7   // PB10
#define XP_GPIO_Port GPIOB
#define YM_Pin LL_GPIO_PIN_6   // PA8
#define YM_GPIO_Port GPIOB
#define YP_Pin LL_GPIO_PIN_4   // PA1
#define YP_GPIO_Port GPIOA
#define XM_Pin LL_GPIO_PIN_5   // PA4
