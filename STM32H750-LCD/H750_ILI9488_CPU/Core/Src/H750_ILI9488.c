...
void LCD_Direction(uint8_t direction)
{
	...
	switch(direction)
	{
		case 0:
			lcddev.width = LCD_W;
			lcddev.height = LCD_H;
			LCD_WriteReg(0x36, (1<<3));	//0 degree
			break;
		case 1:
			lcddev.width = LCD_H;
			lcddev.height = LCD_W;
			LCD_WriteReg(0x36, (1<<6)|(1<<5)|(1<<4)|(1<<3)); //90 degree
			break;
		case 2:
			lcddev.width = LCD_W;
			lcddev.height = LCD_H;
			LCD_WriteReg(0x36,(1<<7)|(1<<6)|(1<<3));//180 degree
			break;
		case 3:
			lcddev.width = LCD_H;
			lcddev.height = LCD_W;
			LCD_WriteReg(0x36, (1<<7)|(1<<5)|(1<<3));//270 degree
			break;
		default:
			break;
	}
