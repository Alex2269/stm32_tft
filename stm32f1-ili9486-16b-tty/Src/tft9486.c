...
void tft_scroll_vertical(uint16_t position)
{
  tft_write_reg(0x37);
  tft_write_data(position >> 8);
  tft_write_data(position & 0xFF);
}
...
void tft_set_rotation(uint8_t rotation)
{
  ...
  if(rotation == 0)
  {
    if(RGB) tft_write_data(0x40|0x08);
    if(BGR) tft_write_data(0x40|0x00);
    tft_W = panel_width;
    tft_H = panel_height;
  }
  ...
  if(rotation == 1)
  {
    if(RGB) tft_write_data(0x20|0x08);
    if(BGR) tft_write_data(0x20|0x00);
    tft_W = panel_height;
    tft_H = panel_width;
  }
  ...
  if(rotation == 2)
  {
    if(RGB) tft_write_data(0x80|0x08);
    if(BGR) tft_write_data(0x80|0x00);
    tft_W = panel_width;
    tft_H = panel_height;
  }
  ...
  if(rotation == 3)
  {
    if(RGB) tft_write_data(0x40|0x80|0x20|0x08);
    if(BGR) tft_write_data(0x40|0x80|0x20|0x00);
    tft_W = panel_height;
    tft_H = panel_width;
  }
