...
#define LCD_RST_SET HAL_GPIO_WritePin(FCMC_RESET_GPIO_Port,FCMC_RESET_Pin,GPIO_PIN_SET)
#define LCD_RST_RESET HAL_GPIO_WritePin(FCMC_RESET_GPIO_Port,FCMC_RESET_Pin,GPIO_PIN_RESET)
