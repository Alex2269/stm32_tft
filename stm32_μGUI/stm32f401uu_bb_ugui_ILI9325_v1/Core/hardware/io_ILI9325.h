...
static inline
void write_pin(uint32_t port, uint8_t pin, bool state)
{
...
static inline
void write_bit(uint32_t Address, uint8_t pin, bool state)
{
...
void tft_write_reg(uint8_t eightbit)
{
  ...
  shift = ((eightbit & 0b00000001) << 7) | // bit 0 -> D7
          ((eightbit & 0b00000010) << 5) | // bit 1 -> D6
          ((eightbit & 0b00000100) << 3) | // bit 2 -> D5
          ((eightbit & 0b00001000) << 1) | // bit 3 -> D4
          ((eightbit & 0b00010000) >> 1) | // bit 4 -> D3
          ((eightbit & 0b00100000) >> 3) | // bit 5 -> D2
          ((eightbit & 0b01000000) >> 5) | // bit 6 -> D1
          ((eightbit & 0b10000000) >> 7) ; // bit 7 -> D0

  static uint16_t control = 0b0000101100000000 | (1<<RD) | (0<<WR) | (0<<DC) | (0<<CS) | (1<<RST);

  GPIOB->ODR = control | shift;
...
void tft_write_data(uint8_t eightbit)
{
  ...
  static uint16_t control = 0b0000101100000000 | (1<<RD) | (0<<WR) | (1<<DC) | (0<<CS) | (1<<RST);
